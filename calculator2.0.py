...
button_12=Button(root,text='CLEAR',bg='#c41417',fg='black',padx=2,pady=15,font = ("Bahnschrift", 13),command=clearfunc)
button_14=Button(root,text='-',bg='#343e78',fg='black',padx=17,pady=5,font = ("Bahnschrift", 20),command=lambda:buttonclick('-'))
...
button_17=Button(root,text='+/-',bg='#32a891',fg='black',padx=6,pady=5,font = ("Bahnschrift", 20),command=inverser)
button_18=Button(root,text='.',bg='#32a891',fg='black',padx=20,pady=5,font = ("Bahnschrift", 20),command=lambda:buttonclick('.'))
button_19=Button(root,text='DEL',bg='#c41417',fg='black',padx=0,pady=5,font = ("Bahnschrift", 20),command=deleter)
...
button_22=Button(root,text='√',bg='#343e78',fg='black',padx=17,pady=5,font = ("Bahnschrift", 20),command=lambda:buttonclick('sqrt('))
